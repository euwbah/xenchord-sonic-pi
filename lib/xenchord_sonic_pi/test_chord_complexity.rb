chords = [
  ...
  [Chord.new(12,15,20),"min 1st inversion (5-lim) - Above without 16"],
  [Chord.new(12,16,20),"maj 2nd inversion (5-lim) - Above without 15"],
  [Chord.new(12,15,16,18),"Maj add4 / rootless closed maj 9 (5-lim)"],
  [Chord.new(12,16,18),"Sus4 (5-lim) - Above without 15"],
  [Chord.new(8,9,12),"Sus2 (5-lim)"],
