...
live_loop :drs do
  with_fx :lpf, cutoff: 63, cutoff_slide: 16 do |lpf_drs|
    with_fx :echo, decay: 2, phase: 0.125, mix: 0.1 do |echo_drs|
      use_bpm 60
      with_random_seed 53 do
        32.times do |k|
          ...
          if false
            onset = [0, 3].choose
            4.times do
              sample :loop_amen, release: 0.125, sustain: 0, onset: onset
              o '/drums', onset
              sleep 1.0/16.0
            end
          elsif smp < 0.85
            ...
            sample :loop_amen, release: 0.3, sustain: 0,
              onset: onset if rand < 0.3 or k % 4 == 0
            o '/drums', onset
            sleep 0.25
          else
            2.times do |i|
